...
2. Colour the biplot points by country in a first plot: do the surveys cluster well by country? do the clusters make sense?
3. Colour the biplot points by PfPr in a second plot
